                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="footer-logo">
                            <img width="50%" src="{{ asset('img/logo/full.png') }}" alt="Footer Logo">
                            <p class="info mt-15">
                        ...
                        <ul class="des">
                            <li>
                                <span>Địa chỉ: </span><a href="{{route('lienhe')}}">180 Cao Lỗ, Phường 4, Quận 8, TP.HCM</a>
                            </li>
                            <li>
                                <span>SĐT: </span>
                                <a href="tel: 0901234567">090.xxx.xnxx (Mr. Tiến)</a>
                            </li>
                            <li>
                                <span>Email: </span>
                                <a href="mailto: dh51805750@student.stu.edu.vn">dh51805750@student.stu.edu.vn</a>
                            </li>
                        </ul>
                    ...
                    <div class="col-lg-3">
                        <div class="footer-block">
                            ...
                            <ul>
                                <li><i class="fa fa-phone"></i> Phòng Kinh Doanh: <p class="footer-lienhe">090.xxx.xnxx
                                        (Mr.Tiến)</p>
                                </li>
                                <li><i class="fa fa-phone"></i> Chăm Sóc Khách Hàng: <p class="footer-lienhe">
                                        090.xxx.xnxx (Mr.Tòn)</p>
                                </li>
                                <li><i class="fa fa-phone"></i> Bảo Hành: <p class="footer-lienhe">090.xxx.xnxx
                                        (Mr.Tiến)</p>
                                </li>
                            </ul>
                        </div>
